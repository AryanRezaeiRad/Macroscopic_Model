...
# for {set Strip $Strip} {$Strip < 5} {incr Strip} {
	...
	# for {set Box $Box} {$Box < 6} {incr Box} {
		...
		# recorder Element -file	$folder/07_Shr_CRS_LNG_Longi/[expr $Strip*100000+$Box*10000+300+99].out        -ele		[expr $Strip*100000+$Box*10000+300+99]		basicForce	
		# recorder Element -file	$folder/07_Shr_CRS_LNG_Longi/[expr $Strip*100000+$Box*10000+300+98].out        -ele		[expr $Strip*100000+$Box*10000+300+98]		basicForce	
...
# recorder Element -file	$folder/08_Shr_CRS_TRS_Longi/[expr $Strip*100000+$Box*10000+400+99].out        -ele		[expr $Strip*100000+$Box*10000+400+99]		basicForce	
# recorder Element -file	$folder/08_Shr_CRS_TRS_Longi/[expr $Strip*100000+$Box*10000+400+98].out        -ele		[expr $Strip*100000+$Box*10000+400+98]		basicForce	
