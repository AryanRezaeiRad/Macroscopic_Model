...
uniaxialMaterial	Elastic $axial_inside						[expr ($E_Timber_Long*600.*40.0)/(3.0*5.0*1174.0)]		
uniaxialMaterial	Elastic $axial_perimeter					[expr 2.0*($E_Timber_Long*600.*40.0)/(2.1*2.0*1174.0)]	

		
uniaxialMaterial	Elastic $IP_Shear_Long						[expr 820.*40.*760./1174.]
uniaxialMaterial	Elastic $IP_Shear_Trs						[expr 820.*40.*1174./760.]

uniaxialMaterial	Elastic $axial								[expr ($E_Timber_Long*300.*40.0)/(1174.0)]		
